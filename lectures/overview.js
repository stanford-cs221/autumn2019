...
prose(
  ...
  'one of the first successful usages of neural networks that became used by the USPS to recognize zip codes.',
_);
...
prose(
  ...
  'for example, the ability to learn quickly from few examples or the ability to perform common sense reasoning.',
  _,
