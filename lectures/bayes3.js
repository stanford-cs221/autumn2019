...
add(slide('Maximum likelihood',
  ...
  pause(),
  stmt('Solution'),
  parentCenter('$\\displaystyle \\red{p_G(\\text{d})} = \\frac{2}{3}, \\red{p_G(\\text{c})} = \\frac{1}{3}, \\green{p_R(5 \\mid \\text{c})} = 1, \\blue{p_R(4 \\mid \\text{d})} = \\frac12, \\blue{p_R(5 \\mid \\text{d})} = \\frac12$').scale(0.6),
  pause(),
...
add(slide('Regularization: Laplace smoothing',
  ...
  parentCenter(xtable(
    '$p(\\text{H}) = \\frac{1 + \\red{1}}{1 + \\red{2}} = \\frac23$', pause(),
    '$p(\\text{H}) = \\frac{998 + \\red{1}}{998 + \\red{2}} = 0.999$',
  _).margin(50)),
_));
...
add(slide('Expectation Maximization (EM)',
  stmt('Intuition: generalization of the K-means algorithm'),
  stmt('Variables: $H$ is hidden, $E = e$ is observed'),
  pause(),
